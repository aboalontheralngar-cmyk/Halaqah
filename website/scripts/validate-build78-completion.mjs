...
assert(pubspec.includes('version: 4.3.0-alpha.24+80'), 'pubspec is not Build 78');
assert(buildInfo.includes("versionName = '4.3.0-alpha.24'") && buildInfo.includes('buildNumber = 80'), 'AppBuildInfo is not Build 78');
