-- P1.27 Build 75 consolidated apply file.
-- Date: 2026-08-12
-- Apply this file to the confirmed current Supabase project, then run
-- P1.27_BUILD75_VERIFY.sql.
-- Do NOT run website/database_schema.sql on an existing database.
-- This file intentionally includes the Build 74 supervision/family repair
-- first, so a partially-applied P7.3/Build74 database is reconciled safely.
