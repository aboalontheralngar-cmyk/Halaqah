...
CREATE TABLE students (
    ...
    student_code TEXT UNIQUE NOT NULL DEFAULT upper(encode(gen_random_bytes(10), 'hex')),
    age INTEGER,
    level TEXT,
    join_date DATE DEFAULT CURRENT_DATE,
    photo_url TEXT,
    plan_type TEXT CHECK (plan_type IN ('ayahs', 'pages', 'lines', 'hizbs')) DEFAULT 'ayahs',
    plan_amount INTEGER DEFAULT 5,
    review_plan_amount INTEGER NOT NULL DEFAULT 10 CHECK (review_plan_amount BETWEEN 1 AND 999),
