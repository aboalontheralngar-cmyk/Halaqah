...
أحدث دفعة إصلاح موثقة هي **P1.27 Build 86 Hotfix 11** فوق `4.3.0-alpha.29+86` وSQLite 28. تضيف التحديد الجماعي والطباعة/الحذف للخطط، وتحوّل واجهة التسميع إلى قائمة Slidable موحدة، وتعالج overflow التقويم الهجري والتقرير التجميعي، وتحوّل الأدوات المتقدمة إلى شبكة مدمجة. لا تحتاج SQL جديدًا. راجع `docs/P1.27_BUILD86_HOTFIX11_UI_WORKFLOWS.md` و`P1.27_BUILD86_HOTFIX11_INSTALL_NOTE.md`.
