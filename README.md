...
أحدث دفعة إصلاح موثقة هي **P1.27 Build 78 Hotfix 3** فوق `4.3.0-alpha.24+78` وSQLite 26. تصلح مخطط المزامنة السحابية الحالي، تضيف تقدمًا مرحليًا وتشخيصًا آمنًا، وتزيل فحص الشبكة المتكرر كل 12 ثانية لصالح foreground sync وadaptive backoff. راجع [Hotfix 3](docs/P1.27_BUILD78_HOTFIX3.md)، [خطة المتبقي](docs/P1.27_REMAINING_PLAN.md)، و`P1.27_BUILD78_HOTFIX3_INSTALL_NOTE.md`.
