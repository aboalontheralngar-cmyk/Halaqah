...
أحدث دفعة إصلاح موثقة هي **P1.27 Build 87 Hotfix 12** فوق `4.3.0-alpha.30+87` وSQLite 28. تعالج تعارض السحب مع التمرير في التسميع، وتضيف قائمة الإجراءات الكاملة والزر العائم السريع، وتحوّل بوابة الطالب إلى proxy من نفس نطاق Vercel، وتصلح مسار pgcrypto لدعوات الإشراف، والوضع الداكن، وتقريب النقاط. تحتاج SQL Build 87 وإعادة نشر `student-portal`. راجع `docs/P1.27_BUILD87_HOTFIX12_PORTAL_RECITATION.md` و`P1.27_BUILD87_HOTFIX12_INSTALL_NOTE.md`.
